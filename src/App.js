...
fetchdata=(city)=>{
  ...
  render(){
    ...
    if(this.state.info!==null){
      ...
      d=<div id="sbkabap-div"><h5>{this.state.info.name} , {this.state.info.sys.country} ,{date.getTime()}</h5>
      <div id="second-div">
     ...
     <p>Sunrise  : <span className="span1">{this.state.info.sys.sunrise}</span>
     <br/>Sunset  : <span className="span1">{this.state.info.sys.sunset}</span></p>
     </div></div>
     <CommentComponent/>
     </div>
    }}
